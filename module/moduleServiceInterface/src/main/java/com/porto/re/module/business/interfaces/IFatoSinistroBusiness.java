...
/**
 * Interface de negocio para consulta de fato de sinistro.
 * 
 * @author bruno.miller
 *
 */
public interface IFatoSinistroBusiness {
	 ...
	 */
	//TODO O retorno deve ser um novo objeto agregando sinistro e demais informações
	Sinistro recuperarFatoSinistro(String codigoRamo, String anoSinistro, String numeroSinistro, String sequenciaItemSinistro);
