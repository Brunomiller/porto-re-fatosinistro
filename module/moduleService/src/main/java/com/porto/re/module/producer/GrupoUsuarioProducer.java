 ...
 */
public class GrupoUsuarioProducer extends BusinessContextProducer<IGrupoUsuarioBusiness> {
	...
	@RequestScoped
	@Override
	public IGrupoUsuarioBusiness create(@Any Instance<IGrupoUsuarioBusiness> instance){
