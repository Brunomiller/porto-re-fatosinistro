...
import com.porto.re.contextaware.application.annotations.RELogic;
...
@Named
@RELogic @Default
public class GrupoUsuarioBusiness2 implements IGrupoUsuarioBusiness2 {
	...
	public GrupoUsuario find(final String primaryKey) {
		return grupoUsuarioDAO.find(GrupoUsuario.class, primaryKey);
	}
