...
/**
 * The primary key class for the ssamitem database table.
 * 
 */
@Embeddable
public class ItemSinistroPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ItemSinistroPK)) {
			return false;
		}
		ItemSinistroPK castOther = (ItemSinistroPK)other;
		return 
